...
O projeto segue uma arquitetura em camadas padrão do Spring:
- `controllers`: Responsáveis por receber as requisições HTTP e retornar as respostas (Endpoints).
- `services`: Contém a regra de negócio da aplicação.
- `models`: Entidades mapeadas para o banco de dados.
